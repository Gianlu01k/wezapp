...
function App() {
  ...
  return (
      //Definizione di routes React per raggiungere le tre pagine che compongono la web app
       <Routes>
...
* Descrizione:
* Titolo: Wezapp
* Linguaggi utilizzati: Javascript, HTML
* Framework utilizzati: express(backend), React(frontend), MUI(stili frontend)
* Database: MongoDB
* Autenticazione e sessione: JWT Token e hashing
* La web app si compone di back end e frontend. Il backend viene eseguito con Node.js tramite server express,
* e contiene la gestione del database, routes e meccanismo di tokenizzazione.
...
* Dalla sidebar è possibile filtrare esclusivamente gli utenti amici dal pulsante a destra della barra di ricerca,
* nella parte alta della sidebar.
* Features minori:
* Clickando sull'avatare dell'utente selezionato in alto alla sezione chat è possibile visualizzare le informazioni
